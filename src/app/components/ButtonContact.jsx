...
function ButtonContact({title}) {
  return (
    <button>
      <Link
        href={`https://api.whatsapp.com/send?phone=6285377640809&text=halo%20pak%2C%20saya%20mau%20tanya%20${title}.`}
        target="_blank"
        className=" 
      ...
      >
        <Image src={'/wa.svg'} alt='Kontak Admin Rental Sumber Semarang' className="invert mr-3" width={24} height={24} />
        Kontak Admin
      </Link>
